...
open class RaireResult {
    ...
    var assertionAndDifficulties: Array<AssertionAndDifficulty>
    ...
    constructor(
        ...
        this.assertionAndDifficulties = assertions
    ...
    constructor(
        ...
        val assertions = mutableListOf<AssertionAndDifficulty>() // A in the original paper
        ...
        this.assertionAndDifficulties = Array(assertions.size) { assertions[it] } // convert to array
        this.time_to_trim_assertions =
            timeout.timeTaken().minus(time_to_find_assertions).minus(time_to_determine_winners)
        this.margin = assertions.stream()
        ...
        for (a in this.assertionAndDifficulties) {
