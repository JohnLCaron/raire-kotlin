...
open class RaireResult {
    ...
    var aandd: Array<AssertionAndDifficulty>
    ...
    constructor(
        ...
        this.aandd = toArray( massertions )
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (!aandd.contentEquals(other.aandd)) return false
    ...
    override fun hashCode(): Int {
        var result = aandd.contentHashCode()
